  ...
  @endauth
    ...
    @endguest
      ...
      <div class="grid grid-rows-18 grid-cols-1 md:grid-rows-10 md:grid-cols-2">
        ...
        <input id="name_on_card" name="name_on_card" type="text" value="{{ $paymentInfo?->name_on_card }}"
          class="w-full h-8 bg-gray-200 rounded-sm px-2" required />
        </div>
        <div
        ...
        <input id="card_number" name="card_number" type="text" value="{{ $paymentInfo?->card_number }}"
          class="w-full h-8 bg-gray-200 rounded-sm px-2" required />
        </div>
        <div
        ...
        <div class="flex flex-col items-center px-2">
          ...
          <input id="expireDate" name="expireDate" type="text" class="h-8 bg-gray-200 w-full rounded-sm px-2"
          required />
        </div>
        <div class="flex flex-col items-center px-2">
          <label for="cardCvc">CVC <span class="text-red-600">*</span></label>
          <input id="cardCvc" name="cardCvc" type="text" class="h-8 bg-gray-200 w-full rounded-sm px-2" required />
        </div>
        </div>
      </div>
      </div>
