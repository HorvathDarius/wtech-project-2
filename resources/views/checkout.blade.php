...
@section('content')
    <main class="w-full h-full overflow-scroll lg:pb-14">
        ...
        @auth
            ...
            @endauth
            @guest
                <form action="{{ route('order.store.anonymous', ['id' => $shoppingCartId]) }}" method="POST"
                    class="grid grid-cols-1 grid-rows-6 sm:grid-cols-1 sm:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1 gap-4 px-4">
                @endguest
                @csrf
                <!-- LEFT CONTAINER -->
                    ...
                    <div class="grid grid-rows-18 grid-cols-1 md:grid-rows-10 md:grid-cols-2">
                        ...
                        <div
                            ...
                            <input id="firstName" name="firstName" type="text"
                                value="{{ explode(' ', $user?->name, 2)[0] ?? '' }}"
                                class="w-full h-8 bg-gray-200 rounded-sm px-2" required />
                        </div>
                        <!-- LAST NAME -->
                        <div
                        ...
                        <div
                            ...
                            <button class="w-full rounded-lg cursor-pointer flex justify-center">
                                <img src="{{ asset('/images/googlePayPaymentOption.png') }}" alt="googlePayPaymentOption"
                        ...
                        <div
                            ...
                            <label for="name_on_card">Name on Card <span class="text-red-600">*</span></label>
                            <input id="name_on_card" name="name_on_card" type="text"
                                value="{{ $paymentInfo?->name_on_card }}" class="w-full h-8 bg-gray-200 rounded-sm px-2"
                                required />
                        </div>
                        <div
                            ...
                            <button class="w-full rounded-sm cursor-pointer flex justify-center">
                                <img src="{{ asset('/images/applePayPaymentOption.png') }}" alt="applePayPaymentOption"
                        ...
                        <div
                            ...
                            <label for="card_number">Card Number <span class="text-red-600">*</span></label>
                            <input id="card_number" name="card_number" type="text"
                                value="{{ $paymentInfo?->card_number }}" class="w-full h-8 bg-gray-200 rounded-sm px-2"
                                required />
                        </div>
                        <div
                            ...
                            <button class="w-full cursor-pointer flex justify-center">
                                <img src="{{ asset('/images/paypalPaymentOption.png') }}" alt="paypalPaymentOption"
                                    class="w-80" />
                            </button>
                        </div>
                        <div
                            ...
                            <div class="flex flex-col items-center px-2">
                                ...
                                <input id="expireDate" name="expireDate" type="text"
                                    class="h-8 bg-gray-200 w-full rounded-sm px-2" required />
                            </div>
                            <div class="flex flex-col items-center px-2">
                            ...
                            <div class="w-full flex items-center gap-4">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <article class="text-md font-light">
                                        ...
                                        <span class="font-bold text-primary">{{ $product->product->product_price }}
                                            €</span>
                                    </article>
                                </div>
                            </div>
                        ...
                        <table class="table-fixed w-full h-full text-lg">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="w-1/3 md:w-1/4 text-primary" id="sub-total">{{ $totalPrice }} €</td>
                                </tr>
                                <tr>
                                    <td>Shipping:</td>
                                    <td class="text-primary" id="delivery-price">0 €</td>
                                </tr>
                                <tr class="border-t-4 border-primary text-xl font-bold">
                                    <td>Total:</td>
                                    <td class="text-primary">
                                        <input name="totalPrice" value="{{ $totalPrice }}" id="total-price" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="w-full h-20 flex flex-col gap-4 justify-center items-center">
                        @auth
                            ...
                            <a href="{{ route('orderSuccess') }}" class="w-full">
                                <button type="submit"
                                    class="bg-primary text-white h-10 w-full px-10 rounded-md cursor-pointer">
                                    Place Order
                                </button>
                            </a>
                        @endauth
        ...
        @vite(['resources/js/test2.js', 'resources/js/calculateDeliveryPrice.js'])
