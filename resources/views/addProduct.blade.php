...
@section('content')
  <div class="grid w-full absolute left-0 top-20 p-4 grid-rows-1 grid-cols-1">
    ...
    <form action="adminPage.html" method="post">
      <div
      class="center border border-outline rounded-md sm:m-4 sm:mt-0 relative grid grid-rows-11 grid-cols-1 lg:grid-rows-6 lg:grid-cols-3">
      <!-- MAIN IMAGE -->
      <div
      ...
      <div class="row-span-1 row-start-4 lg:row-span-1 lg:col-span-1 lg:col-start-2 lg:row-start-1 flex flex-col p-2">
        ...
        <input id="productName" name="productName" type="text" class="w-full h-10 bg-gray-200 rounded-sm" required />
      </div>
      <!-- PRICE INPUT -->
      ...
      <div class="row-span-1 row-start-7 lg:row-span-1 lg:col-span-1 lg:col-start-3 lg:row-start-2 p-2">
        ...
        <input id="redColor" name="redColor" type="checkbox" class="h-6 w-6 rounded-sm accent-primary" />
        <label for="redColor">Crimson Red</label>
        <input id="blueColor" name="blueColor" type="checkbox" class="h-6 w-6 rounded-sm accent-primary" />
        <label for="blueColor">Blueish Blue</label>
        <input id="blackColor" name="blackColor" type="checkbox" class="h-6 w-6 rounded-sm accent-primary" />
        <label for="blackColor">Pitch Black</label>
        </div>
      </div>
      <!-- DESCRIPTION INPUT -->
      <div class="row-span-1 row-start-8 lg:row-span-1 lg:col-span-2 lg:col-start-2 lg:row-start-3 flex flex-col p-2">
