            ...
            <form action="{{ route('products.store') }}" enctype="multipart/form-data" method="post">
                ...
                <div
                    ...
                    <div
                        ...
                        <img src="{{ asset('images/uploadImage.png') }}" alt="uploadImage" class="w-20 h-20 border"
                            id="smallImage" />
                    </div>
                    <!-- PRODUCT NAME INPUT -->
                    <div
                    ...
                    <div
                        ...
                        <input id="price" name="product_price" type="number"
                            class="w-full h-10 bg-gray-200 rounded-sm px-2" required />
                    </div>
                    ...
                    <!-- DESCRIPTION INPUT -->
                    <div
                        class="row-span-1 row-start-8 lg:row-span-1 lg:col-span-1 lg:col-start-2 lg:row-start-3 flex flex-col p-2">
                        <label for="product_description">Product Description <span class="text-red-600">*</span></label>
                        <textarea id="product_description" name="product_description" class="w-full bg-gray-200 rounded-sm px-2" rows="2"
                            required></textarea>
                    </div>

                    <!-- QUANTITY INPUT -->
                    <div
                        class="row-span-1 row-start-9 lg:row-span-1 lg:col-span-1 lg:col-start-3 lg:row-start-3 flex flex-col p-2">
                        <label for="quantity">Quantity <span class="text-red-600">*</span></label>
                        <input id="quantity" name="quantity" type="number" class="w-full h-10 bg-gray-200 rounded-sm px-2"
                            required />
                    </div>
                    ...
                    <div
                        ...
                        <a href="{{ route('adminPage') }}">
                            <button
                                class="text-primary border border-primary h-10 w-80 sm:w-48 px-10 rounded-md cursor-pointer"
                                type="button">
                                Go back
                            </button>
                        </a>
                        ...
                        <button type="submit"
                            class="bg-primary text-white h-10 w-80 sm:w-48 px-10 rounded-md cursor-pointer">
                            Save Changes
                        </button>
                    </div>
                </div>
