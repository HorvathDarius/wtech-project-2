    ...
    <main class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-x-12 mt-8 md:gap-x-5 pb-14">
        ...
        <div class="grid grid-cols-5 grid-rows-4 mb-5 gap-2">
            ...
            <div class="lg:w-32 lg:h-32 md:w-20 md:h-20  sm:w-24 sm:h-full  w-full h-full col-start-1 row-start-1">
                <img src="{{ asset('storage/uploads/images/'.$products->product_category.'/'.$products->product_image_second) }}" alt="thumb1" class="object-cover" />
            </div>
            <div class="lg:w-32 lg:h-32 md:w-20 md:h-20 sm:w-24 sm:h-full w-full h-full col-start-1 row-start-2">
                <img src="{{ asset('storage/uploads/images/'.$products->product_category.'/'.$products->product_image_second) }}" alt="thumb2" class="object-cover" />
            </div>
            <div class="lg:w-32 lg:h-32 md:w-20 md:h-20 sm:w-24 sm:h-full h-full col-start-1 row-start-3">
                <img src="{{ asset('storage/uploads/images/'.$products->product_category.'/'.$products->product_image_second) }}" alt="thumb3" class="object-cover" />
            </div>
            <div class="lg:w-32 lg:h-32 md:w-20 md:h-20 sm:w-24 sm:h-full h-full col-start-1 row-start-4">
                <img src="{{ asset('storage/uploads/images/'.$products->product_category.'/'.$products->product_image_second) }}" alt="thumb4" class="object-cover" />
            </div>
            ...
            <div
                ...
                <img src="{{ asset('storage/uploads/images/'.$products->product_category.'/'.$products->product_image) }}" alt="main"
