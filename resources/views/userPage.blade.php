        ...
        <div
            ...
            @if ($paymentInfo == null)
                <div class="w-full h-full flex flex-col items-center justify-center">
                    ...
                    <p class="text-primary font-bold">You need to place an order in order to see your payment information.
                    </p>
                </div>
            @else
                <form action="/edit-payment-information" method="post"
                        ...
                        <table class="w-full h-full p-6 m-8">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="string" name="paymentCardNumber"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="paymentNameOnCard"
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit"
                            class="bg-primary text-white h-10 px-10 rounded-md m-4 cursor-pointer">Edit</button>
        ...
        <div
            ...
            <div class="w-full h-full flex flex-col items-center justify-center">
                ...
                <a href="{{ route('order.index') }}">
                    <button class="bg-primary text-white h-10 px-10 rounded-md mb-4 cursor-pointer">View all
                        Orders</button>
                </a>
            </div>
        </div>
