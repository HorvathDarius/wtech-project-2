    ...
    <main class="pb-14">
        ...
        <div class="container mx-auto px-25 py-4">
            <input type="text" placeholder="🔍Search..."
                ...
                onkeydown="search(event, this, '{{ route('products.search', ['category' => 'bass']) }}')" />
        </div>
            ...
            @foreach ($products as $item)
                ...
                <a href="{{ url('product/' . $item->product_link_name) }}"
                    ...
                    <div class="relative h-64 flex items-center justify-center">
                        <img src="{{ asset('storage/uploads/images/bass/'.$item->product_image) }}" alt="thumb1" class="object-cover" />
                    </div>
                    <div class="p-4">
